...
import { User, Mail, PieChart, Calendar, Award, Shield, Edit3, Code, Trophy, Star, Clock, TrendingUp, Settings, ArrowLeft, ChartNoAxesColumnIncreasing, Crown } from 'lucide-react';
              ...
              {activeTab === 'activity' && (
                <div className="bg-[#1a1a1a] rounded-lg p-6 border border-gray-800">
                  ...
                  <div className="text-gray-400 text-center py-8">
                    ...
                    <p className="text-sm mt-2">Your solved problems will appear here</p>
                  </div>
                </div>
              )}
