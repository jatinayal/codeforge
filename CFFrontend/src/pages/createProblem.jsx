...
import { Plus, Trash2, Code, FileText, ChevronDown, ChevronUp } from 'lucide-react';
...
function CreateProblem() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      alert('Error creating problem: ' + (error.response?.data || error.message));
    } finally {
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          {errors.visibleTestCases?.[index]?.explaination && (
                            <p className="text-red-500 text-sm mt-1">{errors.visibleTestCases[index].explaination.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
