...
import { Edit, Eye, Loader, ArrowLeft } from 'lucide-react';
...
const AdminUpdate = () => {
  ...
  // Fixed: Changed to use the correct route that matches your router configuration
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Update Problems</h1>
          </div>
